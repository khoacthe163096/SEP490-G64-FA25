namespace DAL.vn.fpt.edu.interfaces
{
    ...
    {
        Task<(bool Success, string? UserId, string? RoleName, long? RoleId)> VerifyCredentialsAsync(string username, string password, CancellationToken cancellationToken = default);
